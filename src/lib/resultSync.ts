    ...
    try {
      ...
      await prisma.match.update({
        ...
        data: {
          ...
          awayScore: r.awayScore,
          wentToPenalties: r.wentToPenalties,
          penaltyHomeScore: ev.penalties ? (orientation === "reversed" ? ev.awayShootout : ev.homeShootout) : null,
          penaltyAwayScore: ev.penalties ? (orientation === "reversed" ? ev.homeShootout : ev.awayShootout) : null,
          winnerTeamId: r.winnerTeamId,
          status: "FINISHED",
          resultConfirmedAt: now,
          resultSource: "espn",
